...
def auto_reply_email(reply_body: str) -> str:
    ...
    ai_disclosure = (
        '<p style="margin-top:24px; padding-top:12px; border-top:1px solid #e5e7e9; '
        'font-size:12px; color:#888;">'
        'This reply was generated by AI on behalf of the 433 West 34th Street Owners Corp '
        'alteration review team. If you have further questions, please reply to this email '
        'and a board member will follow up.'
        '</p>'
    )
    return _wrap("\n".join(html_parts) + "\n" + ai_disclosure)
